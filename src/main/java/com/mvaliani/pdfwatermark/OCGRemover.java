 ...
 * $Id$
 *
 * Adapted for OCG removal for pdf signature - eWard Cartella
 *
...
public class OCGRemover {
   ...
   * 
   * @param reader
   *          a PdfReader containing a PDF document
   * @param layers
   *          a sequence of names of OCG layers
   * @throws IOException
   * @throws DocumentException 
   */
  public void removeLayers(PdfReader reader, String... layers) throws IOException, DocumentException {
    ...
    Files.write(new File("c:/temp/byte3.pdf").toPath(), out);
  }
   ...
   *          the OCGParser
   * @param page
   *          the page dictionary of the page that needs to be parsed.
   * @throws IOException
   */
